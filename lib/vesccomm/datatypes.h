...
typedef enum {
  DBMS_COMM_FW_VERSION = 0,
  DBMS_COMM_JUMP_TO_BOOTLOADER,
  DBMS_COMM_ERASE_NEW_APP,
  DBMS_COMM_WRITE_NEW_APP_DATA,
  DBMS_COMM_GET_VALUES,
  DBMS_COMM_SET_DUTY,
  DBMS_COMM_SET_CURRENT,
  DBMS_COMM_SET_CURRENT_BRAKE,
  DBMS_COMM_SET_RPM,
  DBMS_COMM_SET_POS,
  DBMS_COMM_SET_HANDBRAKE,
  DBMS_COMM_SET_DETECT,
  DBMS_COMM_SET_SERVO_POS,
  DBMS_COMM_SET_MCCONF,
  DBMS_COMM_GET_MCCONF,
  DBMS_COMM_GET_MCCONF_DEFAULT,
  DBMS_COMM_SET_APPCONF,
  DBMS_COMM_GET_APPCONF,
  DBMS_COMM_GET_APPCONF_DEFAULT,
  DBMS_COMM_SAMPLE_PRINT,
  DBMS_COMM_TERMINAL_CMD,
  DBMS_COMM_PRINT,
  DBMS_COMM_ROTOR_POSITION,
  DBMS_COMM_EXPERIMENT_SAMPLE,
  DBMS_COMM_DETECT_MOTOR_PARAM,
  DBMS_COMM_DETECT_MOTOR_R_L,
  DBMS_COMM_DETECT_MOTOR_FLUX_LINKAGE,
  DBMS_COMM_DETECT_ENCODER,
  DBMS_COMM_DETECT_HALL_FOC,
  DBMS_COMM_REBOOT,
  DBMS_COMM_ALIVE,
  DBMS_COMM_GET_DECODED_PPM,
  DBMS_COMM_GET_DECODED_ADC,
  DBMS_COMM_GET_DECODED_CHUK,
  DBMS_COMM_FORWARD_CAN,
  DBMS_COMM_SET_CHUCK_DATA,
  DBMS_COMM_CUSTOM_APP_DATA,
  DBMS_COMM_NRF_START_PAIRING,
  DBMS_COMM_STORE_BMS_CONF = 50,
  DBMS_COMM_GET_BMS_CELLS
} COMM_PACKET_ID_DIEBIEMS;
